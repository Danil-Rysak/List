...
var onDrop = function onDrop(event) {
  ...
  var id = (_a = event.dataTransfer) === null || _a === void 0 ? void 0 : _a.getData("text/plain");
  ...
  if (id) {
    ...
    if (draggableElement) {
      ...
      (_b = event.dataTransfer) === null || _b === void 0 ? void 0 : _b.clearData();
    }
  }
};

var dragArea = document.getElementById("drag-demo");
...
var drop = function drop(event) {
  event.preventDefault(); //     var data = ev.dataTransfer.getData("text");
  //     ev.target.appendChild(document.getElementById(data));
};
